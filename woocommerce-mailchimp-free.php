 ...
 * Plugin URI: https://www.dreamfoxmedia.com/portfolio/woocommerce-delivery-date-premium/
 * Version: 1.0.7
...
if (in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins')))) {
    ...
    function softsdev_mailchimp_submenu_page() {
        add_submenu_page('woocommerce', __('Mailchimp Full', 'softsdev'), __('Mailchimp Group', 'softsdev'), 'manage_options', 'softsdev-mailchimp', 'softsdev_mailchimp_settings');
    }
                    ...
                    <table width="100%" class="form-table">
                        <tr>
                            ...
                            <td>
                                <?php if (@$softsdev_wc_mc_setting['api']) { ?>
                                    ...
                                    <span>
                                        <a href = "http://support.dreamfoxmedia.com/index.php?/Knowledgebase/List/Index/9/configuration" target="_blank">
                        ...
                        <tr style="display: <?php echo @$softsdev_wc_mc_setting['api'] ? '' : 'none' ?>">
                            <th width="170px">
                                ...
                                <img width="16" height="16" src="<?php echo plugins_url('images/help.png', __FILE__) ?>" class="help_tip" title="<?php echo __('Mailchimp List', 'softsdev'); ?>">
                            </th>
                            <td>
    ...
    add_action('woocommerce_save_product_subscription_variation', 'save_variable_product_fields');
